"""
FEATURE-007 görevi için alt görevleri veritabanına ekleyen script.
"""
import sqlite3
import os
import re
...
def add_subtasks_to_feature007():
    """FEATURE-007 için alt görevleri ekle"""
    ...
    try:
        ...
        parent_id = "FEATURE-007-database-integration"
        ...
        subtasks_file = "FEATURE-007-subtasks.md"
        ...
        for subtask_id, subtask_content in subtask_blocks:
            ...
            title = title_match.group(1) if title_match else subtask_id.split('-')[-1].replace('-', ' ')
            ...
            if subtask_exists:
                ...
                print(f"ℹ️ Alt görev {subtask_id} güncellendi.")
            else:
                # Yeni alt görev ekle
                cursor.execute("""
            ...
            if criteria_match:
                ...
                for criteria in criteria_items:
                    ...
                    VALUES (?, ?)
                    """, (subtask_id, criteria))
                print(f"  + {len(criteria_items)} kabul kriteri eklendi.")
            ...
            if dependencies_match:
                ...
                if dependencies_text and dependencies_text != "Yok":
                    ...
                    print(f"  + {len(dependencies)} bağımlılık eklendi.")
        ...
        print(f"✅ Toplam {subtask_count} alt görev {parent_id} görevine eklendi.")
        return True
